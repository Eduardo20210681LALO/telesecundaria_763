...
function EnviarCorreoTelefono() {
  ...
  const VerificarUsuarioActivo = async (e) => {
        ...
        try {
            const response = await fetch('https://telesecundaria763.host8b.me/Web_Services/TeleSecundaria763/verificarUsuario.php', {//   http://192.168.7.116/TeleSecundaria763/verificarUsuario.php
                method: 'POST',
                headers: {
