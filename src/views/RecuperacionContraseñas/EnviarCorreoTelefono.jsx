...
function EnviarCorreoTelefono() {
  ...
  const VerificarUsuarioActivo = async (e) => {
      ...
      try {
          const response = await fetch('http://192.168.1.95/TeleSecundaria763/verificarUsuario.php', {//'https://telesecundaria763.host8b.me/Web_Services/TeleSecundaria763/verificarUsuario.php'
              method: 'POST',
              headers: {
