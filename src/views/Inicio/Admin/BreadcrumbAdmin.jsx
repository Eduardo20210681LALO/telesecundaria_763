...
import { HomeOutlined, FolderOutlined, UserOutlined, TeamOutlined, BarChartOutlined, SettingOutlined, IdcardOutlined } from "@ant-design/icons"; // Añadir IdcardOutlined para "Mi Perfil"
      ...
      <div>
        <Breadcrumb>
          ...
          {pathnames.map((name, index) => {
            ...
            let icon;
            if (name === "Periodos" || name === "CrearGradoYgrupo" || name === "Materias") {
              icon = <FolderOutlined />;
            } else if (name === "CrearDocentes" || name === "OtorgarGradoXGrupoDocente") {
              icon = <UserOutlined />;
            } else if (
            ...
            } else if (name === "PerfilUADM") { // Nueva sección para "Mi Perfil"
              icon = <IdcardOutlined />;
            }
