...
function EstadisticasGeneralXAdmin() {
        ...
        <SIDEBARADMIN>
            <div className="flex flex-col justify-center items-center w-full mx-auto mt-10 gap-6 p-4">
                <div className="bg-white dark:bg-gray-800 shadow-md sm:rounded-lg p-6 w-full max-w-5xl">
                    <h2 className="text-3xl font-bold text-center mb-6" style={{ color: '#B8860B' }}>Estadísticas Generales</h2>
...
export default EstadisticasGeneralXAdmin