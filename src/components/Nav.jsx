...
import './../styles/ColorGuinda.css'; // Estilos globales
import '../styles/Nav.css'; // Estilos adicionales
      ...
      <nav className="fixed top-0 left-0 right-0 border-gray-200 bg-gray-50 dark:bg-gray-800 dark:border-gray-700 shadow-lg z-50">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className="hidden md:flex space-x-8 font-medium">
            ...
            <Link to="/QuienesSomos" className="text-[var(--first-color)] font-bold hover:text-black dark:text-[var(--first-color)] dark:hover:text-black">
              Quiénes Somos
            </Link>
          </div>
          ...
          >
            ...
            >
              <CiCircleRemove className="w-8 h-8 text-black" />
            </button>
            ...
            <div className="flex flex-col h-full p-4">
              <ul className="flex flex-col font-medium space-y-4">
                ...
                <li>
                  <Link to="/QuienesSomos" className="block py-2 px-3 text-[var(--first-color)] font-bold hover:text-white dark:text-[var(--first-color)]">
                    Quiénes Somos
                  </Link>
                </li>
              </ul>
